...
/*  function feedBack(){
    for(let i=0; i < levelInfo.length; i++){
      if(levelInfo[i] + levelInfo[i+1] < 2 && feedback == true){
        console.log("olete liiga range");
        feedback = false;
      } else if(levelInfo[i] + levelInfo[i+1] > 4 && feedback == true){
        console.log("olete liiga pehmo");
        feedback = false;
      } else if(levelInfo[i] == 10 && feedback == true){
        console.log("olete ikka liiga pehmo");
        feedback = false;
      } else if(levelInfo[i] + levelInfo[i+1] > 2 && levelInfo[i] + levelInfo[i+1] < 4 && feedback == true){
        console.log("olete keskmine");
        feedback = false;
      }
    }
  }
...
function feedBack(){
  for(let i=0; i < levelInfo.length; i++){
    ...
    if(levelInfo[i] < 1){
      underAverage ++;
    } else if (levelInfo[i] > 1){
      overAverage ++;

    } if (levelInfo[i+2] < 2){
      underAverage ++;
    } else if (levelInfo[i+2] > 2){
      overAverage ++;

    } if (levelInfo[i+3] < 4){
      underAverage ++;
    } else if (levelInfo[i+3] > 4){
      overAverage ++;

    }if (levelInfo[i+4] < 2){
      underAverage ++;
    } else if (levelInfo[i+4] > 2){
      overAverage ++;

    }if (levelInfo[i+5] < 1){
      underAverage ++;
    } else if (levelInfo[i+5] > 1){
      overAverage ++;
    }
  }
}
